...
def help():
    print("""
import cenz_mail as cmail

myEEMail = cmail.Email()
myEEMail.subject = "This is my Subject"
myEEMail.receiver_email = "programtrade.playground+python@gmail.com"
myEEMail.sender_email = "programtrade.playground@gmail.com"
myEEMail.sender_pass = "programTrade.1234567"
myEEMail.body_text = "This is the Body Text"
myEEMail.sendEmail_withAttachment("image4.png")
myEEMail.sendMail()
myEEMail.dowloadAllAttachmentfrom("python")
myEEMail.deleteAllMailfrom("python")
    """)
